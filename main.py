...
# Streamlit UI  
st.title("Spam Detection Programs: English")

st.header("Login to Your Email Please...>w<!!")
        ...
        try:
            ...
            for email_id in email_ids[-total_emails:]:
                ...
                if body and is_english(body):
                    ...
                    # Make predictions
                    try:
                        spam_prediction = spam_model.predict(body)
                    ...
                    email_data.append({
                        ...
                        'Spam': "Spam" if spam_prediction >= 0.5 else "Ham"
                    })
